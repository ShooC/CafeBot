...
⌬ 𝐏𝐫𝐞𝐦𝐢𝐮𝐦   : ${premium ? `${conn.msToDate(premiumTime - new Date() * 1)}` : 'Free user'}
┗━━━━━━━━━━━━━㉿
┏━━〔 ıll *STATUS INFO* llı 〕━㉿
...
⫹⫺ DATE : ${date}`,
      footer: wm,
      title: judul,
      buttonText: "ılı.lıl Klik lılı.ıllı.",
      sections
    }
    ...
    await conn.send3TemplateButtonImg(m.chat, await genProfile(conn, m), text.trim(), wm, `Creator`, `${_p}owner`, `Ping Bot`, `${_p}ping`, `Donasi`, `${_p}donasi`, m)
  } catch (e) {
